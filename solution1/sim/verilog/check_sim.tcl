...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.multi_axim.autotvin_gmem.dat"
         "c.multi_axim.autotvin_x.dat"
         "c.multi_axim.autotvin_y.dat"
         "c.multi_axim.autotvout_gmem.dat"
         "c.multi_axim.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.multi_axim.autotvout_gmem.dat"
         "rtl.multi_axim.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
