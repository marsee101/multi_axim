...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.multi_axim.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.multi_axim.autotvout_gmem.dat"
...
parameter gmem_mem_depth = 32'd 20;
...
output [32 - 1 : 0] TRAN_gmem_x;
output [32 - 1 : 0] TRAN_gmem_y;
input ready;
input done;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_gmem_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
