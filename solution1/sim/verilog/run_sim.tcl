...
if {[file isfile multi_axim.autotvin.dat]} {
    file delete -force multi_axim.autotvin.dat
}
if {[file isfile multi_axim.autotvout.dat]} {
    file delete -force multi_axim.autotvout.dat
}
