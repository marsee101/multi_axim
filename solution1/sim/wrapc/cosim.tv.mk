...
$(ObjDir)/multi_axim_tb.c_pre.c.tb.o : multi_axim_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multi_axim_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/multi_axim.c_pre.c.tb.o : multi_axim.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) multi_axim.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
