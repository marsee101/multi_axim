set C_TypeInfoList {{ 
"multi_axim" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"x": [[],{ "pointer":  {"scalar": "int"}}] }, {"y": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName multi_axim
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32 ,"direction" : "READWRITE" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "x","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "x"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 9,"step" : 1}]},{"cName": "y","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "y"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 9,"step" : 1}]}]}]} , 
 	{ "Name" : "x", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32 ,"direction" : "READONLY" , "offset" : {"in":24}, "offset_end" : {"in":31}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"multi_axim","role":"start","value":"0","valid_bit":"0"},{"name":"multi_axim","role":"continue","value":"0","valid_bit":"4"},{"name":"multi_axim","role":"auto_start","value":"0","valid_bit":"7"},{"name":"x","role":"data","value":"24"},{"name":"y","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"multi_axim","role":"start","value":"0","valid_bit":"0"},{"name":"multi_axim","role":"done","value":"0","valid_bit":"1"},{"name":"multi_axim","role":"idle","value":"0","valid_bit":"2"},{"name":"multi_axim","role":"ready","value":"0","valid_bit":"3"},{"name":"multi_axim","role":"auto_start","value":"0","valid_bit":"7"},{"name":"return","role":"data","value":"16"}] },
